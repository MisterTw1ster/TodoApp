...
import com.example.domain.usecase.settings.*
import com.example.domain.usecase.tasks.*
import com.example.domain.usecase.users.*
...
import com.example.task_list.di.ListDeps
import com.example.user_auth.di.UserAuthDeps
import com.example.user_select.di.UserSelectDeps
